...
<body>
	...
	<div class="container">
		<p class="h2">Our Collection of cars! </p>
		<div class="row">
			...
			?>
				<div class="col-sm-10 col-md-6 col-lg-4">
					...
					<img src="<?php echo $rowCars['image_url'] ?>"  style="width: 100%; height: 230px;"></img>
					<p class="h4"><?php echo $rowCars['car_name'] ?></p>
					<div class="py-3"><p><?php echo $rowCars['car_type'] ?></p>
					</div>
					<p class="lead">
					<?php echo "Rent this car!";?>
					</p>
					<hr class="py-3">
				</div>
			<?php 
