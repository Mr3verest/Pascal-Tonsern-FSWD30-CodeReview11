...
<body>
	...
	<div class="col-10 mx-auto">
		<p class="h2">We already have 4 offices just in Vienna alone!</p>
		<p>We know it is too much, but we need to fill the Database! See the number of available cars below.</p>
		<table class="table table-striped table-dark">
			<tr>
				<th>Office Name</th>
				<th>Office Location</th>
				<th>Stationed Cars</th>
			</tr>
			<?php 
